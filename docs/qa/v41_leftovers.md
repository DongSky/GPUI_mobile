...
7. **Live GPUI + Chrome recapture** — this VM cannot create a wgpu surface; Chrome `--screenshot` hangs (dump-dom works). Official-vs-catalog strips remain v19 left halves. Recapture HTML heroes (including header Menu/MenuOpen + Arrangement.Bottom) when a display/screenshot pipeline works.
...
3. APK install + Chrome/wgpu recapture of v21–v41 heroes.
