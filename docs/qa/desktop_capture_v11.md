...
| Search | `MorphFrame` / `morph_frame_eased` / `morph_container` | Spatial-fast height + corners + **shared-element inset/scale** + **container color lerp**; HTML `data-search-shared` |
