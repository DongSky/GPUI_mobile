...
pub const INVENTORY: &[ComponentEntry] = &[
    ...
    ComponentEntry {
        ...
        notes: "Tokens only; no shared animation runtime on GPUI yet",
    },
    ComponentEntry {
        name: "Button",
    ...
    ComponentEntry {
        ...
        parity: Parity::Done,
        notes: "Regular 56dp; no extended / small / large FAB",
    },
    ComponentEntry {
        name: "Text field",
        ...
        parity: Parity::Partial,
        notes: "Visual states including error; Android IME / caret editing not wired",
    },
    ComponentEntry {
        name: "List",
        material: "Lists",
