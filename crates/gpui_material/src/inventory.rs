...
pub const INVENTORY: &[ComponentEntry] = &[
    ...
    ComponentEntry {
        ...
        parity: Parity::Done,
        notes: "WideNavigationRailItem Top/Start (Compose iconPositionFor): collapsed Top 56×32 + label-medium, expanded Start 56dp full-width pill + label-large; live Top→Start iconPosition lerp (spatial-fast); wide collapsed 96 / live narrow modal 80↔220; in-flow standard WideNavigationRail 96↔220 no scrim CornerNone/Surface; expanded 220–360 modal overlay 96 collapsed + 32% scrim; modalExpandedShape CornerLarge 16 + ModalContainerColor SurfaceContainer (spatial-fast lerp); dismissible modal hideOnCollapse slides offscreen (Menu ☰, Start items, Arrangement.Center, expanded modal shape); header slot Menu/MenuOpen + Extended FAB Create (56↔188) + plain tooltip Above + Arrangement.Bottom; active label secondary; OsPopupSpec PopUp not opened on Linux/NativeActivity; FAB toggle; badges",
    },
    ComponentEntry {
        name: "Dialog",
