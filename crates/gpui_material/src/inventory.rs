...
pub const INVENTORY: &[ComponentEntry] = &[
    ...
    ComponentEntry {
        ...
        parity: Parity::Done,
        notes: "none through extra-large + full",
    },
    ComponentEntry {
        name: "Elevation",
    ...
    ComponentEntry {
        ...
        parity: Parity::Done,
        notes: "short/medium/long + emphasized eval; catalog CSS transitions; no shared GPUI animation clock",
    },
    ComponentEntry {
        name: "Button",
        ...
        parity: Parity::Done,
        notes: "Default 40dp size; no expressive XS–XL or morph-to-square press",
    },
    ComponentEntry {
        name: "Icon button",
        ...
        parity: Parity::Done,
        notes: "Standard / filled / tonal / outlined; 40dp container, 48dp target",
    },
    ComponentEntry {
        name: "FAB",
        ...
        parity: Parity::Done,
        notes: "Small 40 / regular 56 / large 96 / extended 56+label; no Expressive morph",
    },
    ComponentEntry {
        name: "Text field",
        ...
        parity: Parity::Done,
        notes: "Filled/outlined + editor (insert/backspace/caret/error); NativeActivity update_ime_position remains a stub",
    },
    ComponentEntry {
        name: "List",
        material: "Lists",
    ...
    ComponentEntry {
        ...
        parity: Parity::Done,
        notes: "Baseline You 4dp track / 20dp thumb (not Expressive 16dp stop)",
    },
    ComponentEntry {
        name: "Tabs",
        material: "Tabs",
