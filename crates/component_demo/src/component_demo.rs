...
struct CatalogView {
    ...
    docked_open: bool,
    docked_pane: date_picker::DatePickerPane,
...
impl CatalogView {
    ...
    fn toggle_docked_pane(&mut self) {
        if date_picker::DOCKED_YEAR_PANE {
            self.docked_pane = date_picker::apply_pane_toggle(self.docked_pane);
        }
    }

    fn select_docked_year(&mut self, year: i32) {
        let (y, m) = date_picker::apply_docked_year(self.picker_year, self.picker_month, year);
        self.picker_year = y;
        self.picker_month = m;
...
fn catalog_body(
    ...
    div()
        ...
        .when(
            this.date_display == date_picker::DatePickerDisplayMode::Input,
            |el| {
        ...
        .child(android_date_picker_empty(theme, pick))
        .child(android_date_input(this, theme, pick))
        .child(android_date_input_empty(theme, pick))
        ...
        .child(android_date_range_input_end_only(theme, pick))
        ...
        .child(
            div()
                ...
                .children(labels.into_iter().map(|(value, label, x, y, selected)| {
                    ...
                    let a11y = time_picker::clock_number_label(face, value, this.time_format);
                    let tip_open = this.clock_number_tooltip.as_deref() == Some(a11y.as_str());
                    div()
                    ...
                    div()
                        ...
                        .child(
                            div()
                                .text_size(px(pick.year_style.size_sp))
                                .text_color(paint(pick.header_year))
                                .child(date_picker::INPUT_HEADLINE),
                        )
                        .child(
                            div()
                                .text_size(px(22.))
                                .text_color(paint(pick.header_date))
                                .child(date_picker::PICKER_EMPTY_HEADLINE),
                        ),
                )
                .child(
                    div()
                    ...
                    div()
                        ...
                        .child(
                            div()
                                .text_size(px(pick.year_style.size_sp))
                                .text_color(paint(pick.header_year))
                                .child(date_picker::INPUT_SUPPORTING),
                        ),
                )
                .child(
                    div()
                    ...
                    div()
                        ...
                        .child(
                            div()
                                .text_size(px(pick.date_style.size_sp.min(22.0)))
                                .text_color(paint(pick.header_date))
                                .child(date_picker::INPUT_EMPTY_HEADLINE),
                        ),
                )
                .child(
                    div()
                            ...
                            div()
                                ...
                                .child(
                                    div()
                                        .text_size(px(22.))
                                        .text_color(paint(pick.header_date))
                                        .child(date_picker::header_range_selection(
                                            this.date_range,
                                        )),
                                ),
                        )
                ...
                div()
                    ...
                    .child(
                        div()
                            .text_size(px(field.input_style.size_sp))
                            .text_color(paint(field.input))
                            .child(date_picker::range_field_value(this.date_range, false)),
                    ),
            )
            .child(
                div()
...
fn android_date_range_input_empty(
    theme: &Theme,
    pick: &date_picker::DatePickerAppearance,
) -> impl IntoElement {
    let field = text_field::resolve(
...
fn android_date_range_input_end_only(
    theme: &Theme,
    pick: &date_picker::DatePickerAppearance,
) -> impl IntoElement {
    let field = text_field::resolve(
            ...
            div()
                ...
                .child(
                    div()
                        .text_size(px(field.input_style.size_sp))
                        .text_color(paint(field.input))
                        .child(date_picker::range_field_value(sel, true)),
                ),
        )
        .child(
            div()
    ...
    Application::with_platform(platform).run(|cx: &mut App| {
        cx.open_window(gpui::WindowOptions::default(), |_window, cx| {
            cx.new(|cx| CatalogView {
                ...
                docked_pane: date_picker::LIVE_PANE,
