...
fn catalog_body(
    ...
    div()
        ...
        .child(date_range_picker_empty_card(theme, &pick))
            ...
            .child(
                div()
                    ...
                    .when(calendar_pane, |nav| {
                        nav.child(div().id("docked-month-prev").p(px(8.)).child("<").on_click(
                            cx.listener(|this, _, _, cx| {
                    ...
                    .when(calendar_pane, |nav| {
                        nav.child(div().id("docked-month-next").p(px(8.)).child(">").on_click(
                            cx.listener(|this, _, _, cx| {
                                this.shift_docked_month(1);
                                cx.notify();
                            }),
                    ...
                    div()
                        ...
                        .children(date_picker::year_window(this.picker_year).into_iter().map(
                            |year| {
                                ...
                                div()
                                    .id(SharedString::from(format!("docked-year-{year}")))
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .gap(px(4.))
                        .child(spaced_line(
                            date_picker::RANGE_PICKER_TITLE,
                            pick.year_style.size_sp,
                            paint(pick.header_year),
                        ))
                        .child(
            ...
            date_picker::range_visible_months(2026, 9)
                ...
                .map(|(year, month)| {
                    ...
                    div()
                        ...
                        .flex_col()
                        .child(spaced_line(
                            date_picker::month_subhead_label(year, month),
                            pick.month_subhead_style.size_sp,
                            paint(pick.month_subhead),
                        ))
                        .child(div().w(px(cal_w)).flex().flex_wrap().children(
                    ...
                    div()
                        ...
                        .child(
                            div()
                                .font_weight(type_weight(pick.date_style))
                                .child(spaced_line(
                                    date_picker::INPUT_EMPTY_HEADLINE,
                                    pick.date_style.size_sp,
                                    paint(pick.header_date),
                                )),
                        ),
...
fn date_range_input_empty_card(
    theme: &Theme,
    pick: &date_picker::DatePickerAppearance,
) -> impl IntoElement {
    let field = text_field::resolve(
...
fn date_range_input_start_only_card(
    theme: &Theme,
    pick: &date_picker::DatePickerAppearance,
) -> impl IntoElement {
    let field = text_field::resolve(
