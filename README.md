...
| Time picker | Time pickers (dial + TimeScroll) | done | Expressive TimeScroll + TimeInput + 24h ClockFace (outer 00–11 / inner 12–23, 101/69dp); ScrollFieldDefaults.shape / TimePickerDefaults.shapes() CornerLarge 16; ClockDisplayBottomMargin 36 + ClockFaceBottomMargin 24 on Vertical; DisplaySeparatorWidth 24 + PeriodToggleMargin 12 | [spec](https://m3.material.io/components/time-pickers/specs) |
