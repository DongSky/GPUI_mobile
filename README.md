...
| Text field | Filled and outlined text fields | done | Floating label; outlined C-path even-odd notch (RoundedPolygon cubics live); Roboto-advance notch; IME JNI queue + JNIEnv sink (no live JVM yet) | [spec](https://m3.material.io/components/text-fields/specs) |
...
| Progress | Linear and circular progress indicators | done | Determinate + wavy + Expressive 7-shape morph loading + contained PTR + WaitProgress determinate morph + circular/PTR LineCap::Round stroke | [spec](https://m3.material.io/components/progress-indicators/specs) |
...
| Search | Search bar + view | done | 56dp docked bar shared-element growing-bar into full-screen search activity (leading/back + avatar crossfade; MorphLayerTransform top-center; GPUI scaled-margin stand-in) | [spec](https://m3.material.io/components/search/specs) |
...
HTML, not GPUI pixels. Latest live frames: `docs/qa/desktop_capture_v13.md`.
