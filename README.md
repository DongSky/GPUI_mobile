...
| Date picker | Date pickers | done | Modal calendar; range hero with live start→end, month nav, YearPicker, showModeToggle, Confirm/Cancel, drawRangeBackground half-cell connectors; modal Confirm/Cancel + month nav (docked still commits on select); docked popup | [spec](https://m3.material.io/components/date-pickers/specs) |
