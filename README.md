...
| Tooltip | Plain + rich tooltips | done | Plain inverse-surface 24dp extra-small; rich surface-container medium elev 2 + two actions; Add to library / Learn more hero. Banner is not on the current Expressive list | [spec](https://m3.material.io/components/tooltips/specs) |
