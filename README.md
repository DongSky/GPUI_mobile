...
| Icon button | Icon buttons | done | Expressive XS–XL (32/40/56/96/136), narrow/default/wide (Compose IconButtonWidthOption; S 32/40/52), round/square, press morph; default S 40×24 | [spec](https://m3.material.io/components/icon-buttons/specs) |
