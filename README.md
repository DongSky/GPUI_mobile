...
| Chip | Assist / filter / input / suggestion chips | done | 32dp; Filter/Input Expressive ChipShapes morph (medium 12 / full selected / small 8 pressed) + selected check; tonal leading icon on-surface-variant; ElevatedFilterChip surface-container-low elev 1; Assist/Suggestion stay full-round | [spec](https://m3.material.io/components/chips/specs) |
...
| Navigation rail | Navigation rail | done | WideNavigationRailItem Top/Start: collapsed 96 (narrow 80) 56×32; expanded 220–360 Start 56dp pill; active label secondary; modal overlay + 32% scrim | [spec](https://m3.material.io/components/navigation-rail/specs) |
